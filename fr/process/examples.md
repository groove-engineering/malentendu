...
Compagnon de [`method.md`](method.md) (la spec) et
[`personas.md`](personas.md) (qui décide).
...
Le produit est la **représentation** (la source). Les modèles sont interchangeables.
Ce qu'on écoute revient corriger la source — jamais le tuyau.
...
On curate les **atomes** (les ~600 genres), pas les molécules (les 360 000 fusions).
...
Un raté de genre corrige l'atome ; un bel accident va au catalogue.
...
Ces trois exemples se sont produits pendant le développement. Ils illustrent la méthode mieux que n'importe quelle théorie.
